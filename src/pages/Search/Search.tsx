...
import type { IFavouriteDoctor, ISpecialist } from "@/types";
...
const Search = () => {
    ...
    const [doctors, setDoctors] = useState<IFavouriteDoctor[]>([]);
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                const dataDoctor: IFavouriteDoctor[] = await fetchDoctorsData();
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                const dataSpecialties: ISpecialist[] =
                    await fetchSpecialitiesData();
                        ...
                        <div className="flex flex-wrap gap-3">
                            {specialties.map((specialty) => (
                                <button
                                    key={specialty.id}
                                    onClick={() =>
                                        toggleSpecialty(specialty.name_en)
                                    }
                                ...
                                >
                                    ...
                                    {specialty.name_en === "Cardiologist" &&
                                        "❤️"}
                                    ...
                                    {specialty.name_en === "Ophthalmologist" &&
                                        "👁️"}
