...
const schema = Yup.object({
    ...
    holder: Yup.string().min(2, "Too short").required("Cardholder name is required"),
    number: Yup.string()
                ...
                <Formik
                    ...
                    onSubmit={async (values, { setSubmitting, resetForm }) => {
                        try {
                            ...
                            const arr: StoredCard[] = raw ? JSON.parse(raw) : [];
                            arr.push(newCard);
                            localStorage.setItem("payment_cards", JSON.stringify(arr));
                    ...
                    {({ isSubmitting, values, setFieldValue }) => (
                        <Form className="space-y-4">
                            ...
                            <div>
                                ...
                                <ErrorMessage name="brand" component="div" className="mt-1 text-xs text-rose-600" />
                            </div>
                            ...
                            <div>
                                ...
                                <ErrorMessage name="holder" component="div" className="mt-1 text-xs text-rose-600" />
                            </div>
                            ...
                            <div>
                                ...
                                <ErrorMessage name="number" component="div" className="mt-1 text-xs text-rose-600" />
                            </div>


                            <div className="grid grid-cols-3 gap-3">
                                <div>
                                    <label className="mb-1 block text-sm font-medium text-zinc-900">Expiry Date</label>
                                ...
                                <div className="col-span-1">
                                    <label className="mb-1 block text-sm font-medium text-zinc-900">CVV Code</label>
                                    <div className="rounded-xl border border-zinc-200 bg-zinc-100 px-3">
                                        <Field
                                            name="cvv"
                                            placeholder="CVV"
                                    ...
                                    <ErrorMessage name="cvv" component="div" className="mt-1 text-xs text-rose-600" />
                                </div>
