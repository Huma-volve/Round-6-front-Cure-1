...
export default function Hero() {
  return (
    <div className="flex flex-col gap-6 min-h-screen items-center justify-center relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0">
        <img src={BigEllipse} alt="Big Ellipse" className="min-w-[900px]" />
        ...
        <div className="absolute hidden md:flex flex-col gap-2 items-center justify-center top-[20%] -left-5 z-20">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0">
        <img src={Ellipse} alt="Small Ellipse" className="min-w-[400px]" />
      </div>

      {/* Content (inside smallest ellipse) */}
      <div className="flex flex-col gap-4 items-center justify-center relative z-40 text-center">
        <div className="py-1 px-5 bg-primary/10 flex items-center justify-center gap-2 rounded-full">
          <svg
            width="25"
            height="25"
            viewBox="0 0 15 14"
        ...
        <p className="w-[80%] lg:w-[42%] text-sm md:text-2xl text-secondary-400 z-40">
        ...
        <div className="py-2 px-5 bg-primary/10 flex items-center justify-center gap-4 rounded-full">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          ...
          <Button className="bg-white text-primary px-5 py-2 rounded-md border border-primary flex gap-2 items-center w-[200px] hover:bg-primary hover:text-white">
